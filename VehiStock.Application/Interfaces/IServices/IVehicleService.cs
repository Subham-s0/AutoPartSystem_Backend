...
{
    Task<IReadOnlyCollection<CustomerVehicleResponse>> GetVehiclesAsync(
        string userId,
        VehicleQueryRequest query,
        CancellationToken cancellationToken = default);

    Task<IReadOnlyCollection<CustomerVehicleResponse>> GetVehiclesForCustomerAsync(
        int customerId,
        VehicleQueryRequest query,
        CancellationToken cancellationToken = default);
    ...
    Task<CustomerVehicleResponse> CreateVehicleForCustomerAsync(int customerId, CreateVehicleRequest request, CancellationToken cancellationToken = default);
