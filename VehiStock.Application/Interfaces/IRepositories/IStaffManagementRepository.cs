...
{
    Task<(IReadOnlyCollection<ApplicationUser> Users, int TotalRecords)> GetStaffUsersAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default);
